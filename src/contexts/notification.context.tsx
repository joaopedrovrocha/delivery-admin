...
export const NoticiationProvider: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    <NotificationContext.Provider value={{ notify }}>
      ...
      <div
        aria-live="assertive"
        className="pointer-events-none fixed inset-0 flex items-end px-4 py-6 sm:items-start sm:p-6 z-[900]"
      >
              ...
              <div className="p-4">
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                    ...
                    {notification?.type === 'error' && (<XMarkIcon className="h-6 w-6 text-red-400" aria-hidden="true" />)}
                  </div>
